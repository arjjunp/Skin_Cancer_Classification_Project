...
def plant(request):
    ...
    import h5py
    models = keras.models.load_model('E:/CODE/django Deploy/employee/skin_cancer1.h5')
    from tensorflow.keras.preprocessing import image
    test_image = image.load_img('E:/CODE/django Deploy/media/'+ str(result1), target_size=(220, 220))
